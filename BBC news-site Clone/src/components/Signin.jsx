  ...
  return (
    <div className='bg-black grid grid-cols-2 h-screen'>
      ...
      <div className='bg-black text-center'>
        <img className='h-16 ml-[18rem] mt-40 rounded-none' src={logo} alt="" />
        <h1 className='text-white text-3xl mt-7 font-bold'>Sign in</h1>
        <button type="button" class="text-white mt-8 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium text-xl px-5 py-2.5 text-center w-80 hover:scale-110 ">Next</button>
